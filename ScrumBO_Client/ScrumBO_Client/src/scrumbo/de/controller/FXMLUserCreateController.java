 ...
 * @author Serdar
 */
public class FXMLUserCreateController implements Initializable {
		...
		if (checkPreName() && checkLastName() && checkPassword() && checkEmail() && checkRole()) {
			if (checkIfEmailExists(txtFieldEmail.getText())) {
				...
				try {
					...
					this.root = FXMLLoader.load(getClass().getResource("/scrumbo/de/gui/FXMLUserCreateSuccess.fxml"));
					this.scene = new Scene(root);
					Stage stage = (Stage) buttonBackCreateUser.getScene().getWindow();
					stage.setScene(scene);
				} catch (Exception e) {
					...
					e.printStackTrace();
					this.root = FXMLLoader.load(getClass().getResource("/scrumbo/de/gui/FXMLUserCreateFail.fxml"));
					this.scene = new Scene(root);
					Stage stage = (Stage) buttonBackCreateUser.getScene().getWindow();
					stage.setScene(scene);
				}
